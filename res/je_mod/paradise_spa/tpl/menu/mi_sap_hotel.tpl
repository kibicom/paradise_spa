...
<div 	class="toolbar_item_div sub_menu_item sub_menu_item_stl mi_service_and_price mi_service_and_price_down_stl "
		...
		"
			...
			f:tpl_struct_arr
			^
			tpl_path:	res/je_mod/paradise_spa/tpl/service_and_price_hotel.tpl&
		...
		<div class="js_btn_label_stl_smpl">
			<div>
				<div class="mi_name_img">
					<div class="font_open_sans_white_stl f_s_4_stl mi_sap_block">
						ГОСТИНИЧНЫЕ НОМЕРА
					</div>
				</div>
				<div class="mi_name_img_alt hidden">
					<div class="font_open_sans_gold_stl f_s_4_stl mi_sap_block">
						ГОСТИНИЧНЫЕ НОМЕРА
					</div>
				</div>
			</div>
