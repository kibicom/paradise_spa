...
<div class="" style="width:780px; height:100%; margin:0 auto; text-align: justify;padding-left: 10px;margin-top_: -10px;">
	...
	<div style="height:5%"></div>
	<div class="font_open_sans_gold_stl f_s_3_stl content_3" style="width:110%; height:85%; padding-bottom: 0px; overflow:auto;margin-left: -5%;">
