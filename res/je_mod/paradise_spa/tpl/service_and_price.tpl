...
<div class="" style="width:65%; height_:100%; margin:0 auto; text-align: justify;padding-left: 10px;">
	<div class="font_open_sans_white_stl f_s_3_stl" style="width:90%; padding-bottom: 20px; margin:0 auto;">
	...
	<div class="font_open_sans_gold_stl f_s_3_stl content_3" style="width:100%; height:100%; padding-bottom: 20px;">
